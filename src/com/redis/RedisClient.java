...
public class RedisClient {
	...
	private void HashOperate() {
        ...
        System.out.println("新增key004和4的整型键值对："+shardedJedis.hincrBy("hashs", "key004", 41));
	...
	private void ListOperate() {
        ...
        System.out.println("=============增=============");
        //shardedJedis.lpush("stringlists", "vector","arraylist");
	...
	private void StringOperate() {
		System.out.println("清空库中所有数据："+jedis.flushAll());
		System.out.println("=============增=============");
